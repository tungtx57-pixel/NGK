...
class DownloadService : Service() {
    ...
    companion object {
        ...
        const val ACTION_DOWNLOAD = "anhiutangerinee.kittisu.action.DOWNLOAD"
        const val ACTION_CANCEL = "anhiutangerinee.kittisu.action.CANCEL_DOWNLOAD"
        const val ACTION_DISMISS_DOWNLOAD = "anhiutangerinee.kittisu.action.DISMISS_DOWNLOAD"
        const val ACTION_INSTALL_MODULE = "anhiutangerinee.kittisu.action.INSTALL_MODULE"
