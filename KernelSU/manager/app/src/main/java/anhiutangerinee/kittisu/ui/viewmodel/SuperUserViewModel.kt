...
enum class AppCategory(val displayNameRes: Int, val persistKey: String) {
    ALL(anhiutangerinee.kittisu.R.string.category_all_apps, "ALL"),
    ROOT(anhiutangerinee.kittisu.R.string.category_root_apps, "ROOT"),
    CUSTOM(anhiutangerinee.kittisu.R.string.category_custom_apps, "CUSTOM"),
    DEFAULT(anhiutangerinee.kittisu.R.string.category_default_apps, "DEFAULT");
...
enum class SortType(val displayNameRes: Int, val persistKey: String) {
    NAME_ASC(anhiutangerinee.kittisu.R.string.sort_name_asc, "NAME_ASC"),
